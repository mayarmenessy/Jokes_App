...
namespace JokesWebApplication.Controllers
{
    public class JokesController : Controller
    {
        ...
        {
            return View("Index",await _context.Joke.Where(j=> j.jokesQuestion.Contains(searchPhrase)).ToListAsync());
        }
        ...
        [Authorize]
        public async Task<IActionResult> Create([Bind("id,jokesQuestion,jokesAnswers")] Joke joke)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize]
        public async Task<IActionResult> Edit(int id, [Bind("id,jokesQuestion,jokesAnswers")] Joke joke)
        {
            if (id != joke.id)
            {
                return NotFound();
